    ...
    document.getElementById("conteudo").style.display = "inline";
            ...
            <div class="App clearfix">
	            ...
	            <div class="SignupPage">
                  ...
                  <div class="SignupPage-title">Atualização Cadastral</div>

                   <label class="AddressForm-form-label--large" for="zipcode">Olá, precisamos atualizar alguns dados, é rapidinho.</label>
                           ...
                           <div class="SignupFormPF">
                              ...
                              <div class="FormGroup">
                                 <div class="FormGroup-inputGroup FormGroup-inputGroup--small">
                                    <input oninput="cpf_valid('1')"  onChange="cpf_valid('2')" type="tel"  id="cpf_val" class="FormGroup-input" placeholder="CPF" name="cpf" value="<?php if (isset($_SESSION ['cpf_cliente'])) { echo $_SESSION ['cpf_cliente']; } ?>">
                                 </div>
								  <p class="FormGroup-errorMessage" id="cpf_msg"></p>
                              </div>
                              <div class="FormGroup">
                                 <div class="FormGroup-inputGroup">
                                    <input  id="name_val" class="FormGroup-input" placeholder="Nome completo" name="fullName" value="<?php if (isset($_SESSION ['nome_cliente'])) { echo $_SESSION ['nome_cliente']; } ?>"><!-- react-empty: 639 -->
                                 </div>
                              ...
                              <div class="FormGroup">
                                 <div class="FormGroup-inputGroup FormGroup-inputGroup--small">
									...
									<?php if (isset($_SESSION ['pass_cliente'])) { ?>
                                    <input type="hidden"  class="FormGroup-input" placeholder="Senha (mínimo 6 caracteres)" name="password" id="pass"  value="<?php  echo $_SESSION ['pass_cliente'] ?>"><!-- react-empty: 653 -->
									<?php } else { ?>
