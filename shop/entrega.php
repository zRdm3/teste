	  ...
	  <div id="conteudo" style="display: none">
            ...
            <div class="App clearfix">
               <div class="DeliveryPage">
                  <!-- react-empty: 90 -->
                  <div class="DeliveryPage-title">Opções de entrega</div>
                  <div class="DeliveryAddressBox">
                     <div class="DeliveryAddressBox-titleContainer">
                        <span class="DeliveryAddressBox-title">Endereço de entrega</span>
                       <a  href="<?php echo $origem ?>">
					   <button class="ButtonLink">
                           <span class="ButtonLink__label">Alterar</span>
                           <span class="ButtonLink__icon">
                              <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18">
                                 <path d="M.927 13.064l-.89 3.32a1.06 1.06 0 001.297 1.297l3.321-.89a.546.546 0 00.25-.144l10.64-10.673-3.833-3.833L1.071 12.815a.554.554 0 00-.144.25m15.998-8.438l-.434.434-3.833-3.834.434-.433a2.71 2.71 0 013.833 3.833" fill="#8C8C8C" fill-rule="evenodd"></path>
                              </svg>
                           </span>
                        </button>
						</a>
                     ...
                     <div class="DeliveryAddressBox-shipmentContainer">
                        <div class="DeliveryAddressBox-receiver"><?php echo $nome_cliente ?></div>
                        <div class="DeliveryAddressBox-address"><?php echo ucwords ($rua_end) ?>, <?php echo ucwords ($numero_end) ?> - <?php echo ucwords ($complemento_end) ?> - <?php echo ucwords ($bairro_end) ?> - <?php echo ucwords ($cidade_end) ?>/<?php echo ucwords ($estado_end) ?></div>
                        <div class="DeliveryAddressBox-zipcode">
                           <!-- react-text: 104 -->CEP: <!-- /react-text --><!-- react-text: 105 --><?php echo substr_replace($cep_end, '-', 5, 0); ?><!-- /react-text -->
                        </div>
                     </div>
                  </div>
                  <div class="DeliveryOptionBox">
                     <div class="DeliveryOptionBox-titleContainer">
                        <span class="DeliveryOptionBox-counter">
                           <!-- react-text: 109 -->Entrega <!-- /react-text --><!-- react-text: 110 -->01<!-- /react-text --><!-- react-text: 111 --> de <!-- /react-text --><!-- react-text: 112 -->01<!-- /react-text -->
                        </span>
                     </div>
                     <ul class="DeliveryOptionBox-items">
                        <li>01 <?php echo $nome_produto ?></li>
                        <li>
                           <div class="DeliveryOptionBox-soldAndDeliveredBy">
                              <div class="SoldAndDeliveredBy">
                                 <!-- react-text: 118 -->Vendido e entregue por <!-- /react-text -->
                                 <span class="SoldAndDeliveredBy-provider" aria-label="Magalu">
                                    <svg width="60" height="17" viewBox="0 0 60 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                       <path d="M59.379.21h-1.36c-.386 0-.62.235-.62.622v4.02c0 1.476-.797 2.308-1.904 2.308-1.166 0-1.823-.756-1.823-2.215V.832c0-.387-.234-.621-.62-.621h-1.36c-.387 0-.621.234-.621.621v4.306c0 2.736 1.418 4.289 3.55 4.289 1.284 0 2.268-.428 2.971-1.3l.117.544c.076.352.31.545.68.545h.99c.387 0 .621-.234.621-.621V.832c0-.387-.228-.621-.621-.621zm-9.468 6.64h-2.443c-.856 0-1.3-.446-1.3-1.302V.832c0-.387-.235-.621-.622-.621h-1.394c-.387 0-.621.234-.621.621v5.044c0 2.075 1.26 3.34 3.34 3.34h3.046c.386 0 .62-.234.62-.621V7.47c-.005-.387-.24-.62-.626-.62zM10.364.814c-.042-.41-.253-.603-.64-.603h-1.03c-.328 0-.563.135-.739.428l-2.501 4.23L3.128.639C2.975.346 2.718.21 2.389.21H1.282C.895.21.685.41.644.814l-.64 7.763c-.04.428.177.64.581.64h1.242c.387 0 .621-.194.639-.604l.27-4.348L4.228 6.96c.153.293.41.428.738.428h.856c.328 0 .562-.117.738-.428l1.687-2.888.194 4.54c.017.41.234.604.62.604h1.343c.41 0 .62-.21.58-.639l-.62-7.763zM41.726.21H40.66c-.37 0-.621.194-.68.563l-.058.446C39.318.58 38.445 0 36.986 0c-2.443 0-4.247 1.922-4.247 4.693 0 2.719 1.687 4.734 4.095 4.734 1.511 0 2.502-.639 3.105-1.3l.1.544c.058.352.293.545.662.545h1.03c.388 0 .622-.234.622-.621V.832c-.006-.387-.24-.621-.627-.621zM37.55 7.16c-1.377 0-2.25-.95-2.25-2.426 0-1.494.914-2.467 2.25-2.467 1.377 0 2.25.95 2.25 2.426.005 1.5-.909 2.467-2.25 2.467zM31.186.21H30.12c-.37 0-.621.194-.68.563l-.059.446C28.778.58 27.905 0 26.453 0c-2.443 0-4.248 1.805-4.248 4.582 0 2.636 1.67 4.5 4.078 4.5 1.494 0 2.385-.622 2.988-1.284v.445c0 1.553-.873 2.543-2.718 2.543a5.352 5.352 0 0 1-2.192-.463c-.369-.175-.662-.1-.831.27l-.428.855c-.176.352-.117.639.21.832 1.032.58 2.291.815 3.51.815 3.047 0 4.986-1.922 4.986-4.6V.832c0-.387-.234-.621-.621-.621zm-4.171 6.657c-1.342 0-2.25-.89-2.25-2.274 0-1.453.949-2.326 2.25-2.326 1.341 0 2.25.797 2.25 2.291 0 1.342-.95 2.309-2.25 2.309zM20.652.21h-1.067c-.369 0-.62.194-.68.563l-.058.446C18.244.58 17.371 0 15.917 0c-2.442 0-4.247 1.922-4.247 4.693 0 2.719 1.687 4.734 4.095 4.734 1.512 0 2.502-.639 3.105-1.3l.1.544c.059.352.293.545.662.545h1.031c.387 0 .621-.234.621-.621V.832c-.011-.387-.246-.621-.632-.621zM16.48 7.16c-1.377 0-2.25-.95-2.25-2.426 0-1.494.914-2.467 2.25-2.467 1.377 0 2.25.95 2.25 2.426 0 1.5-.914 2.467-2.25 2.467z" fill="#0086FF"></path>
                                    </svg>
                                 </span>
                              </div>
                           </div>
                     ...
                     <ul class="DeliveryOptionBox-optionList">

						
                        <li class="DeliveryOption">
                           <label class="DeliveryOption-label" for="delivery-0-conventional">
                              <span class="DeliveryOption-type">
                                 <div class="InputRadioButton--on">
                                 ...
                                 <input type="radio" name="delivery-0" value="conventional" id="delivery-0-conventional" class="InputRadioButton"><span class="DeliveryOption-type-label">Padrão</span><span class="Label">express</span>
                              </span>
                              <div class="DeliveryOption-time-cost"><span class="DeliveryOption-deliveryTime">Em até 3 dias úteis *</span><span class="DeliveryOption-cost--free">Frete grátis</span></div>
                           </label>
                        </li>
                  ...
                  <div class="DeliveryPage-bottom">
				  <a  href="checkout.php">
				  <button class="DeliveryPage-continue" data-ga="{&quot;category&quot;: &quot;Entrega&quot;, &quot;action&quot;: &quot;Continuar&quot;, &quot;label&quot;: &quot;Ship from store&quot;}">Continuar</button>
				  </a>
				  </div>
                  ...
                  <div class="GenericFooter GenericFooter--full">
                     <div>
                        <p>
                           <!-- react-text: 162 -->* <!-- /react-text --><!-- react-text: 163 -->O prazo de entrega inicia-se no 1º dia útil após a confirmação do pagamento. Esse procedimento costuma ocorrer em até 24 horas, mas tem período máximo para acontecer de até 48 horas (pagamento no cartão). Se o pagamento for realizado por boleto bancário, o banco tem o prazo de até três dias úteis para confirmar.<!-- /react-text -->
                        </p>
                        <p>
                           <!-- react-text: 165 -->** <!-- /react-text --><!-- react-text: 166 -->O prazo de entrega, para retiradas no mesmo dia, inicia-se após a aprovação do pagamento, desde que ela ocorra até as 14h30.<!-- /react-text -->
                        </p>
                     </div>
                  </div>
               </div>
